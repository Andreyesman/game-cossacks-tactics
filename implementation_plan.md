...
**Мінімальний набір:**
- [ ] Козак з шаблею (дефолтний)
- [ ] Козак з мушкетом
- [ ] Козак зі списом
- [ ] Бандит (2 варіанти)
- [ ] Татарин (2 варіанти: легкий, важкий)
- [ ] Яничар
- [ ] Реєстровий козак
...
- [ ] Анімації: idle, attack, walk, death (мінімум idle + death) — відкладено після фінального арту
...
### 4.5.5 Глобальна карта — текстури ⬜

**Що:** Замінити кольорові прямокутники біомів на текстури. Покращити іконки локацій.

**Мінімальний набір:**
- [ ] Текстура лісу (зелена з деревами)
- [ ] Текстура степу (жовто-коричнева)
- [ ] Текстура кордону (сіро-синя)
- [ ] Іконки локацій: місто, село, табір, руїни, фортеця (замість геометричних фігур)
- [ ] Іконка загону гравця (замість жовтого кружечка)

**Джерела:** itch.io (world map tilesets), AI генерація

**Інтеграція:**
- [ ] WorldMap._render_biomes() → TextureRect замість ColorRect
- [ ] LocationMarker._draw() → Sprite2D замість draw_circle/draw_polygon
- [ ] PlayerParty → Sprite2D замість draw

**Оцінка:** 8 годин (код 3 + арт 5)
